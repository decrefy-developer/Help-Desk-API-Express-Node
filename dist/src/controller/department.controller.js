...
exports.updateDepartmetNameHandler = exports.readAllDepartmentsHandler = exports.readDepartmentHandler = exports.createDepartmentHandler = void 0;
...
function createDepartmentHandler(req, res) {
    return __awaiter(this, void 0, void 0, function () {
        var newDepartment, e_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, department_service_1.createDepartment(req.body)];
                case 1:
                    newDepartment = _a.sent();
                    return [2 /*return*/, res.send(newDepartment)];
                case 2:
                    e_1 = _a.sent();
...
function readDepartmentHandler(req, res) {
    return __awaiter(this, void 0, void 0, function () {
        var id, department, e_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    id = lodash_1.get(req, "params.id");
                    return [4 /*yield*/, department_service_1.findDepartment({ _id: id })];
                case 1:
                    department = _a.sent();
                    return [2 /*return*/, res.send(department)];
                case 2:
                    e_2 = _a.sent();
...
exports.readDepartmentHandler = readDepartmentHandler;
function readAllDepartmentsHandler(req, res) {
    return __awaiter(this, void 0, void 0, function () {
        var page, limit, sort, search, status_1, isActive, departments, e_3;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    ...
                    return [4 /*yield*/, department_service_1.findAllDepartment(page, limit, sort, search, isActive)];
                case 1:
                    departments = _a.sent();
...
exports.readAllDepartmentsHandler = readAllDepartmentsHandler;
function updateDepartmetNameHandler(req, res) {
    return __awaiter(this, void 0, void 0, function () {
        var id, update, e_4;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    id = lodash_1.get(req, "params.id");
                    return [4 /*yield*/, department_service_1.findAndUpdate({ _id: id }, req.body, { new: true })];
                case 1:
                    update = _a.sent();
...
exports.updateDepartmetNameHandler = updateDepartmetNameHandler;
